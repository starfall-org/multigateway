        ...
        child: Column(
          ...
          children: [
            ...
            SettingsCard(
              child: Column(
                children: [
                  ...
                  SwitchListTile(
                    title: Text(tl('Top P')),
                    value: controller.isTopPEnabled,
                    onChanged: (value) => controller.toggleTopP(value),
                  ),
                  if (controller.isTopPEnabled)
                    _ParameterSlider(
                      value: controller.topPValue,
                      min: 0,
                      max: 1,
                      divisions: 20,
                      label: controller.topPValue.toStringAsFixed(2),
                  ...
                  SwitchListTile(
                    title: Text(tl('Top K')),
                    value: controller.isTopKEnabled,
                    onChanged: (value) => controller.toggleTopK(value),
                  ),
                  if (controller.isTopKEnabled)
                    _ParameterSlider(
                      value: controller.topKValue,
                      min: 1,
                      max: 100,
                      divisions: 99,
                      label: controller.topKValue.round().toString(),
                  ...
                  SwitchListTile(
                    ...
                    value: controller.isTemperatureEnabled,
                    onChanged: (value) => controller.toggleTemperature(value),
                  ),
                  if (controller.isTemperatureEnabled)
                    _ParameterSlider(
                      value: controller.temperatureValue,
                      min: 0,
                      max: 2,
                      divisions: 20,
                      label: controller.temperatureValue.toStringAsFixed(2),
            ...
            _NumberField(
              ...
              value: controller.contextWindowValue,
            ...
            _NumberField(
              ...
              value: controller.conversationLengthValue,
            ...
            _NumberField(
              label: tl('Max Tokens'),
              value: controller.maxTokensValue,
